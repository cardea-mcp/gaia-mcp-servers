...
use search::SearchServer;
use tracing_subscriber::{self, layer::SubscriberExt, util::SubscriberInitExt};

const DEFAULT_SOCKET_ADDR: &str = "127.0.0.1:8008";
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!("Starting Gaia Search MCP server on {}", args.socket_addr);
